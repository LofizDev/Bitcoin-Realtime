...
import Dropdown from '../TableTrade/dropdown/Dropdown';
...
const TableTrade = () => {
    ...
    return (
        <div style={{ margin: '0 auto' }} className='table-trade'>
            ...
            <div className="coin-name">
                ...
                <p id='total-coin'>Thời gian giao dịch</p>
            </div>
